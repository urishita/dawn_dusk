...
BEGIN_MESSAGE_MAP(CSameGameApp, CWinAppEx)
...
// CSameGameApp customization load/save methods

void CSameGameApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CSameGameApp::LoadCustomState()
{
}

void CSameGameApp::SaveCustomState()
{
}
